...
namespace Terça_Feira
{
    internal static class Program
    {
        ...
        internal static void Main()
        {
            ...
            if (!createNew)
            {
                MessageBox.Show($"{PRController.Name} já está aberto, não foi possível executar duplo progama ao mesmo tempo!", "Aviso", MessageBoxButtons.OK);
                return;
